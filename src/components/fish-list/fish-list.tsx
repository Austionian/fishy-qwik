            ...
            <div
              ...
              class={classNames(
                ...
                i === fishData.data.length - 1
                  ...
                  : "",
                "group relative bg-gradient-to-b from-teal-50 to-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-teal-500"
              )}
            >
              <div
              ...
              <div class="mt-4 flex justify-between">
                ...
                <div onClick$={() => (showUserDetialsModal.value = true)}>
                  <span class="cursor-pointer ml-4 inline-flex items-center rounded-full bg-teal-100 px-3 py-0.5 text-teal-800 hover:bg-teal-200 hover:text-teal-900 hover:ring-teal-300 hover:ring-2">
                    {calculateServings(
