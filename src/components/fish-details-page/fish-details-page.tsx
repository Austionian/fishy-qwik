...
import { calculateServings, getFetchDetails } from "~/helpers";
          ...
          <div class="mt-6 sm:mt-0 flex flex-col-reverse justify-stretch space-y-4 space-y-reverse">
            {favorite.value ? (
              <button
                ...
                onClick$={() => {
                  if (fishData.fish_data.fish_type_id) {
                    serverSaveFishFavorite(
                      false,
                      fishData.fish_data.fish_type_id
                    );
                  } else {
                    serverSaveFishFavorite(false, fishData.fish_data.fish_id);
                  }
              ...
              <button
                ...
                onClick$={() => {
                  if (fishData.fish_data.fish_type_id) {
                    ...
                    serverSaveFishFavorite(true, fishData.fish_data.fish_id);
                  }
                  favorite.value = true;
                }}
              >
