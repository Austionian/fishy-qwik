      ...
      <main class="pb-10">
        ...
        <div class="mx-auto max-w-3xl md:block md:items-center md:justify-between md:space-x-5 lg:max-w-7xl mb-10">
          <div class="flex justify-center items-center flex-wrap space-x-5">
            <div class="bg-teal-500/20 dark:bg-gray-900 dark:ring-1 dark:ring-gray-800 p-2 shadow-sm rounded mb-4 w-screen flex justify-center">
        ...
        <div class="mx-auto mt-4 grid max-w-3xl grid-cols-1 gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
          <div class="space-y-6 lg:col-span-2 lg:col-start-1">
            <section aria-labelledby="fish information">
              <div class="bg-white dark:bg-gray-900 shadow sm:rounded-lg dark:ring-gray-800 dark:ring-1">
          ...
          >
            <div class="bg-white dark:bg-gray-900/95 dark:ring-gray-800 dark:ring-1 px-4 py-5 shadow sm:rounded-lg sm:px-6">
              <h2
                id="recipes-title"
