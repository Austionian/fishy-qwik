...
export default component$(({ text, hideAlert }: Props) => {
  return (
    <div class="rounded-md bg-teal-50 dark:bg-teal-800 p-4 fixed top-[10px] sm:top-[70px] left-[5%] w-[90%] max-w-7xl mx-auto ring-teal-500 dark:ring-white/10 ring-1 z-50">
      <div class="flex">
