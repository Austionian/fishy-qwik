...
import { calculateServings, getUserDetials } from "~/helpers";
            ...
            <section aria-labelledby="applicant-information-title">
              <div class="bg-white shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6">
                  ...
                  <span class="inline-flex items-center rounded-full bg-teal-100 px-3 py-0.5 text-sm font-medium text-teal-800">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                  <FishDetails fish={fishData.value.fish_data} index={false} />
                </div>
              </div>
            </section>
          </div>
