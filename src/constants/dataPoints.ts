const dataPoints = {
  protein: {
    title: "Protein",
    about: `Protein is a key nutrient and an important part of a healthy diet.
...
Lean protein sources, like fish, are especially healthy choices.`,
  ...
  pcb: {
    title: "PCB",
    about: `PCBs stands for Polychorinated Biphenyls. They are chemicals that were banned years ago that persist in food today. If too much builds up in your body you could have health problems. If you get pregnant, high levels of PCBs in your body may hurt the baby. Most fish are safe to eat even with some PCBs in them, ask your doctor if this worries you.`,
    moreInfo:
  ...
  omega_3_ratio: {
    ...
    about: `Omega-3 fatty acids are what are commonly called “good fats.”
      Omega-3 fatty acids from fish include DHA and EPA which may reduce the risk of heart disease and depression.
          DHA and EPA are also important nutrients for pregnant mothers.
  ...
  mercury: {
    title: "Mercury",
    about: `Human activity, especially coal-fired power plants, is the main source of mercury in the environment. Fish that are higher on the food chain, like tuna, tend to have more mercury than fish lower on the food chain, like herring.
